      ...
      <div className="space-y-4">
        {events.map((event, index) => (
          <div key={event.year} className="relative flex items-start gap-3 group last:pb-0">
            ...
            <div className="absolute left-[7px] top-4 bottom-0 w-px -mb-4 bg-zinc-700 group-last:bottom-auto group-last:h-12 group-last:bg-transparent group-last:before:absolute group-last:before:inset-0 group-last:before:bg-gradient-to-b group-last:before:from-zinc-700 group-last:before:to-transparent" />
