...
export async function generateMetadata({
  ...
  return {
    title: tagDef ? `${tagDef.name} Case Studies | Hivemind Solutions` : 'Case Studies | Hivemind Solutions',
    description: tagDef ? `Explore our client success stories and projects relating to ${tagDef.name}.` : undefined,
  };
}
