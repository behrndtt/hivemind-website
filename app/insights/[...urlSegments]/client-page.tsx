  ...
  return (
    <ErrorBoundary>
      <Section>
        ...
        <div data-tina-field={tinaField(insight, 'author')} className='flex items-center justify-center mb-16'>
          {insight.author && (
            <>
              {insight.author.avatar && (
                <div className='shrink-0 mr-4'>
                  <Image
                    data-tina-field={tinaField(insight.author, 'avatar')}
                    priority={true}
              ...
              <p
                data-tina-field={tinaField(insight.author, 'name')}
        ...
        <div data-tina-field={tinaField(insight, '_body')} className='prose dark:prose-dark w-full max-w-none'>
          <TinaMarkdown
