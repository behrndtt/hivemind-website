...
const buttonVariants = cva(
  "group inline-flex min-h-11 items-center justify-center gap-2 text-sm font-medium ring-offset-background transition-[color,background-color,border-color,box-shadow,transform] duration-200 hover:-translate-y-px active:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 shrink-0 motion-reduce:transform-none",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "rounded-lg px-4 py-2 has-[>svg]:px-3",
        sm: "rounded-md gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "rounded-lg px-8 py-2.5 has-[>svg]:px-4",
